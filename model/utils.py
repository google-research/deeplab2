...
_PREDICTION_WITH_NEAREST_UPSAMPLING = [
    common.TARGET_INSTANCE_KEY,
    common.TARGET_INSTANCE_CENTER_KEY,
    common.TARGET_INSTANCE_SCORES_KEY,
    common.TARGET_PANOPTIC_KEY,
    common.TARGET_SEMANTIC_KEY,
]

_PREDICTION_WITH_BILINEAR_UPSAMPLING = [
    common.TARGET_SEMANTIC_PROBS_KEY,
]
